  ...
  return (
    <div>
      <div className={styled.Bitrix24_Solutions_box}>
        <h1 className={styled.Bitrix24_Solutions_Box_h1}>Bitrix24 Solutions</h1>
      </div>

      <div style={{height:"120px",marginTop:"3%", paddingLeft:"40%",margin:'auto'}}>
<b> <h1 style={{fontSize:"36px",margin:"auto"}}>Bitrix24 Solutions</h1></b>
      </div>
      <div className={styled.last_Div}>
        <div className={styled.last_div_child}>
          ...
          <div>
            <b><p className={styled.last_div_p1}>By role</p></b>
          </div>
          <div>
        ...
        <div className={styled.img_div}>
          ...
          <div>
            <b><p className={styled.last_div_p1}>By industry</p></b>
          </div>
          <div>
        ...
        <div className={styled.img_div1}>
          ...
          <div>
          <b> <p className={styled.last_div_p1}>By need</p></b>
          </div>
          <div>
          ...
          <div>
            <p className={styled.last_div_p} style={{lineHeight:"20px"}}>Management and <br />Leadership</p>
          </div>
        ...
        <div className={styled.img_div1}>
          ...
          <div>
           <b> <p className={styled.last_div_p1}>By tool</p></b>
          </div>
          <div>
        ...
        <div className={styled.img_div1}>
          ...
          <div>
            <b><p className={styled.last_div_p1}> By business size</p></b>
          </div>
